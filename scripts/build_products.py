...
This will be used to populate the main products page efficiently without fetching each file.
"""
...
def build_index():
    ...
    print(f"Successfully built index with {len(products_index)} products at {INDEX_PATH}")
