...
- `fr/` و `ar/`: المجلدات الخاصة باللغات الإضافية. تحتوي على نسخ من الصفحات الأساسية (`index.html`, `products.html`, وغيرها) مهيأة هندسياً ومترجمة للـ SEO للفرنسية والعربية. وأيضاً تحتوي على مجلدات `products/` بداخلها والتي يتم توليد صفحاتها الديناميكية للمنتجات.
