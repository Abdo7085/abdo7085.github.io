...
(function(){
  ...
  "Residential Services": "spa_domotique_services",
  ...
  "Integrated control systems for lighting, HVAC, and security to optimize energy usage and enhance operational efficiency.": "spa_desc_electrical_installations",
  "High-performance wireless networks designed for business environments with multiple access points and advanced security features.": "spa_desc_power_distribution_panels",
  ...
  "Call Now: +212 654-132112": "spa_call_now_phone",
    ...
    "How long does installation take?": "spa_q_sell_products",
  "The installation timeline depends entirely on the project's complexity. A simple setup like a few smart switches and a shutter can be completed in under a day. A full-house automation system for a villa can take several days to a few weeks.": "spa_a_sell_products",
  "It depends on the project scope. A simple setup like smart switches or a security camera can be done in a few hours. A full smart home system or network infrastructure for a villa may take several days to a couple of weeks.": "spa_a_sell_products",
  ...
  "Commercial Automation": "spa_title_electrical_installations",
  "Enterprise WiFi": "spa_title_power_distribution_panels",
