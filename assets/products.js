    ...
    return `
      <a href="${prefix}/products/${product.id}.html" class="prod-card prod-fade-in product-link">
        <div class="prod-card-img-wrapper">
          ...
          <button type="button" class="prod-card-add" data-trigger="cart-add" data-product-id="${product.id}" aria-label="Add to cart" data-i18n-attr="aria-label:cart_aria_add_btn">
